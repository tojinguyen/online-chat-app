...
import { Friend as BaseFriend, getFriends } from "@/services/friendService";
                    ...
                    {friends.map((friend) => (
                      ...
                      >
                        <div className="relative">
                          <div className="w-12 h-12 rounded-full overflow-hidden shadow-sm">
                            {renderAvatar(friend.name, friend.avatar_url)}
                          </div>
                          <span
                      ...
                      <div className="flex justify-center pt-4">
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            disabled={friendsPage === 1 || loadingFriends}
                            className={`p-1.5 rounded-md text-sm font-medium transition-colors ${
                              friendsPage === 1 || loadingFriends
                                ? "bg-gray-100 text-gray-400 cursor-not-allowed"
                                : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                            }`}
                          >
                          ...
                          <button
                            onClick={() => {
                              if (friendsPage < friendsTotalPages) {
                                setFriendsPage(friendsPage + 1);
                                loadFriends();
                              }
                            }}
                  ...
                  {friendsTotalPages > 1 && (
                    <div className="flex justify-between items-center border-t border-gray-100 pt-4 mt-2">
                      <p className="text-xs text-gray-500">
                        ...
                        <span className="font-medium">
                          {Math.min(
                            friendsPage * friendsLimit,
                            friendsTotalCount
                          )}
                        </span>{" "}
                        of{" "}
                        <span className="font-medium">{friendsTotalCount}</span>{" "}
                        friends
                      </p>
                      <div className="flex space-x-1">
                        <button
                ...
                <div className="w-12 h-12 rounded-full overflow-hidden shadow">
                  {renderAvatar(
                    ...
                    conversations.find((c) => c.id === selectedChat)
                      ?.avatarUrl ||
                      friends.find((f) => f.id === selectedChat)?.avatar_url
                  )}
                </div>
                <div className="ml-3 flex-1">
